...
/* harmony import */ var _modules_trainers_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/trainers-slider */ "./js/modules/trainers-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_video__WEBPACK_IMPORTED_MODULE_2__["initVideos"])();
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])();
    Object(_modules_trainers_slider__WEBPACK_IMPORTED_MODULE_4__["initTrainersSlider"])();
...
var TABS_CONTAINER_ATTRIBUTE = 'data-tab-container';
var TABS_BAR_ATTRIBUTE = 'data-tabs-bar';
var TAB_BUTTON_ATTRIBUTE = 'data-tab-button';
var TAB_CONTENT_ATTRIBUTE = 'data-tab-content';
var TAB_INDEX_ATTRIBUTE = 'data-tab-index';
var IS_ACTIVE_CLASS = 'is-active';
var DEFAULT_ACTIVE_TAB_INDEX = 0;
var tabsContainers = document.querySelectorAll("[".concat(TABS_CONTAINER_ATTRIBUTE, "]"));
var setActiveTab = function setActiveTab(tabIndex, tabsElements) {
...
var setTabsBarClickHandler = function setTabsBarClickHandler(tabButtonElements, tabContentElements) {
  return function (event) {
    ...
    var tabIndex = Number(target.getAttribute(TAB_INDEX_ATTRIBUTE));
    setActiveTab(tabIndex, tabButtonElements);
    setActiveTab(tabIndex, tabContentElements);
  };
};
var setupTabs = function setupTabs(tabsContainer) {
  var tabsBar = tabsContainer.querySelector("[".concat(TABS_BAR_ATTRIBUTE, "]"));
  var tabButtonElements = tabsBar.querySelectorAll("[".concat(TAB_BUTTON_ATTRIBUTE, "]"));
  var tabContentElements = tabsContainer.querySelectorAll("[".concat(TAB_CONTENT_ATTRIBUTE, "]"));
  ...
  var tabsBarClickHandler = setTabsBarClickHandler(tabButtonElements, tabContentElements);
...
var initTabs = function initTabs() {
  ...
  tabsContainers.forEach(function (tabsContainer) {
    return setupTabs(tabsContainer);
  });
};
...
/***/ "./js/modules/trainers-slider.js":
/*!***************************************!*\
  !*** ./js/modules/trainers-slider.js ***!
  \***************************************/
/*! exports provided: initTrainersSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTrainersSlider", function() { return initTrainersSlider; });
var sliderElement = document.querySelector('[data-trainers-slider]');
var sliderNext = document.querySelector('[data-trainers-slider-next]');
var sliderPrev = document.querySelector('[data-trainers-slider-prev]');
...
var VIDEO_QUERY = '?rel=0&showinfo=0&autoplay=1';
var NOJS_CLASS_ENDING = '--nojs';
var videoIdItems = ['9TZXsZItgdw'];
var generateURL = function generateURL(id) {
  return "".concat(IFRAME_URL).concat(id).concat(VIDEO_QUERY);
};
var createIframe = function createIframe(id, mediaClassName) {
...
var enableButton = function enableButton(video) {
  var mainClass = video.classList[0];
  video.classList.remove("".concat(mainClass).concat(NOJS_CLASS_ENDING));
};
var setupVideo = function setupVideo(video, id) {
  var linkElement = video.querySelector('[data-video-link]');
  var buttonElement = video.querySelector('[data-video-button]');
  var mediaElement = video.querySelector('[data-media]');
  var mediaClassName = mediaElement.classList[0];
  video.addEventListener('click', function () {
    var iframeElement = createIframe(id, mediaClassName);
    linkElement.remove();
...
var initVideos = function initVideos() {
  ...
  videos.forEach(function (video, index) {
    return setupVideo(video, videoIdItems[index]);
  });
};
